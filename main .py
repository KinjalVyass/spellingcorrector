...
def checkSpelling():
    ...
    correctedText.set("The corrected words are: "+str(b.correct())) #Showing the corrected word
...
Label(wn, text='Please enter the words',bg='SlateGray1',font=('calibre',13,'normal'), anchor="e", justify=LEFT).place(x=20, y=70)
